  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-6 sm:p-12 font-inter">
      <div className="max-w-2xl mx-auto space-y-10">
        ...
        {/* Header */}
        <h1 className="font-vogue text-3xl tracking-tight">Mi perfil</h1>

        {/* Card Avatar */}
        <div className="bg-zinc-900/50 border border-white/10 rounded-2xl p-6 flex items-center gap-6">
          <div className="w-20 h-20 rounded-full bg-emerald-400/10 border border-emerald-400/20 flex items-center justify-center text-emerald-400 font-vogue text-3xl shadow-[0_0_20px_rgba(52,211,153,0.1)]">
            {nameInitial}
          </div>

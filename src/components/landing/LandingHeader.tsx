...
export default function LandingHeader() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Translate header slightly on scroll
      if (header) {
        ...
        */}
        <nav className="nav-liquid relative flex items-center justify-between w-full rounded-full px-10 py-[18px]">
          ...
          <div
            ref={glassRef}
            aria-hidden="true"
            className="nav-liquid-lens absolute inset-0 rounded-full pointer-events-none -z-10"
          />
